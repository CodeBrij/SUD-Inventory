...
const AddUsers = () => {
    ...
    const handleFileUpload = async () => {
        ...
        try {
            ...
            toast(err.response?.data?.message || "Error processing the request. Please try again.")
            setResponseMessage("");
            setResponseData([]);
        } finally {
            setIsLoading(false);
            ...
            <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md border border-gray-200">
                ...
                <div className="flex justify-end">
                    <button
                        ...
                        className={`px-4 py-2 rounded-md text-white font-medium flex items-center ${isLoading ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'
                        ...
                        <div className="divide-y divide-gray-200 max-h-80 overflow-y-auto">
                            {responseData.map((item, idx) => (
                                <div key={idx} className="px-4 py-3 flex items-center hover:bg-gray-50">
                                    <div className={`flex-shrink-0 h-6 w-6 rounded-full flex items-center justify-center ${item.msg.includes("✅") ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'
                                        }`}>
                                        {item.msg.includes("✅") ? (
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <p className={`text-xs ${item.msg.includes("✅") ? 'text-green-600' : 'text-red-600'
                                            }`}>
                                            {item.msg}
                                        </p>
                                    </div>
